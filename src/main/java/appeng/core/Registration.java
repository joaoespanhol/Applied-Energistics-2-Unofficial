...
public final class Registration {
    ...
    void postInit(final FMLPostInitializationEvent event) {
        ...
        Upgrades.VOID.registerItem(items.cell1k(), 1);
        ...
        Upgrades.VOID.registerItem(items.cell4k(), 1);
        ...
        Upgrades.VOID.registerItem(items.cell16k(), 1);
        ...
        Upgrades.VOID.registerItem(items.cell64k(), 1);
        ...
        Upgrades.VOID.registerItem(items.cell256k(), 1);
        ...
        Upgrades.VOID.registerItem(items.cell1024k(), 1);
        ...
        Upgrades.VOID.registerItem(items.cell4096k(), 1);
        ...
        Upgrades.VOID.registerItem(items.cell16384k(), 1);
        ...
        Upgrades.VOID.registerItem(items.cellContainer(), 1);
        ...
        Upgrades.VOID.registerItem(items.cellQuantum(), 1);
        ...
        Upgrades.VOID.registerItem(items.cellSingularity(), 1);
        ...
        Upgrades.VOID.registerItem(items.cellUniverse(), 1);
